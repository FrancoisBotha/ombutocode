...
git commit -m "Upgrade Ombuto Code to 0.2.17"
```
...
git clone --depth 1 --branch v0.2.17 https://github.com/FrancoisBotha/ombutocode.git ombutocode-upgrade-scratch
```

Replace `v0.2.17` with the tag you're upgrading to. Check the available
